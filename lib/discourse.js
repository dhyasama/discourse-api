...
Discourse.prototype.postMultipart = function(url, parameters, callback) {
  var postUrl = this.url + '/' + url + '?api_key=' + this.api_key + '&api_username=' + this.api_username;
  request.debug = true;
  request.post( postUrl, {formData: parameters}, (error, response, body) => {
...
Discourse.prototype.postWithUrlParams = function(url, formParameters, urlParameterString, callback) {

  var postUrl = this.url + '/' + url + '?api_key=' + this.api_key + 
  '&api_username=' + this.api_username + '&' + urlParameterString;

  request({
      uri: postUrl,
      method: 'POST',
      useQuerystring: true,
      form: querystring.stringify(formParameters),
    },
    function (error, response, body) {
