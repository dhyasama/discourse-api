exports = module.exports = function(Discourse, actionTypeEnum) {
  ...
  Discourse.prototype.createTopic = function (params, callback) {
    this.post('posts', { 'name': params.name, 'title': params.title, 'raw': params.raw, 'category': params.category, 'archetype': params.archetype || 'regular', 'tags[]': params.tag }, (error, body, httpCode) => {
